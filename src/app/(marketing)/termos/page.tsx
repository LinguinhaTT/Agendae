...
export const metadata: Metadata = {
  title: "Termos de Uso",
  description: "Termos de Uso do InkBook — leia antes de usar a plataforma.",
};
      ...
      <div className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed">
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            Ao acessar ou usar a plataforma InkBook, você concorda com estes Termos de Uso. Se não
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            O InkBook é uma plataforma de agendamento online que conecta profissionais de estética,
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">É proibido usar o InkBook para:</p>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            Todo o conteúdo da plataforma (código, design, marca, textos) pertence ao InkBook. Ao
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            O InkBook não se responsabiliza por: perdas indiretas ou consequentes; falhas de
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            ...
            <a href="mailto:legal@inkbook.app" className="text-primary hover:underline">
              legal@inkbook.app
            </a>
          </p>
        </section>
